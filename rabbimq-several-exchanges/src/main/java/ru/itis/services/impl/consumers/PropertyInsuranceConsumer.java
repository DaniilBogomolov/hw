...
@Component("gmedical_property")
public class PropertyInsuranceConsumer extends AbstractConsumer {

    public static final String QUEUE_NAME = "property_insurance_queue";
    public static final String PDF_TEMPLATE_NAME = "properties";
    ...
    protected PdfDocument generateDocument() {
        return new PdfDocument(new PdfReader(PDF_TEMPLATE_NAME),
                new PdfWriter(new FileOutputStream("documents/" + new Date().toString() + UUID.randomUUID().toString() + ":properties.pdf")));
    }
